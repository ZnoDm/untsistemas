...
<body style="background: #12377B;">
    <div class="container">
        ...
        <div class="row" style="background: #dd0a0a;" >
            <div class="col py-4">
                <h3 class="text-center" style="color: #FFFFFF;">DENEGADA</h3>
            </div>
        </div>
        
        <div class="row" style="background:#FFFFFF;" >
            <div class="col p-5 fs-5">
                <p>Estimado estudiante, <span class="fw-bold"> {{$alumno1->apellido.' '.$alumno1->nombre}} </span> </p>
                <p>Su solicitud ha sido rechazada, teniendo en cuenta lo siguiente: </p>
                <h4>OBSERVACIONES:</h4>
                {!!$mensajito!!}
                <br>
