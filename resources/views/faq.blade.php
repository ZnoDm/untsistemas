    ...
    <main class="p-5 bg-light-blue">
      <div class="flex justify-center items-start my-2">
        <div class="max-w-7xl mx-auto">
          <h2 class="font-bold text-4xl text-center mb-3" style="color: white">FAQ - Preguntas Frecuentes.</h2>
          <ul class="flex flex-col">
            <li class="bg-white my-2 shadow-lg" x-data="accordion(1)">
              <h2
                @click="handleClick()"
                class="flex flex-row justify-between items-center font-semibold p-3 cursor-pointer bg-yellow-300"
              >
